...
{% if c.facebook_url != "" or c.instagram_url != "" or c.snapchat_url != "" or c.tiktok_url != "" or c.linkedin_url != "" or c.x_url != "" %}
...
<ul>
  ...
  {% if c.tiktok_url != "" %}<li><a href="{{ c.tiktok_url }}" rel="noopener" target="_blank">TikTok</a></li>{% endif %}
